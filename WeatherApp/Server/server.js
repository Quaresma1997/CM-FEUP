...
app.get("/:city", (req, res) => {
    request('https://api.apixu.com/v1/forecast.json?key=fbf305ea8c454be0b53142701192904&q=' + req.params.city + '&days=5', function (error, response, body) {
        ...
        const region = parsed.location.region;
        ...
        const date_1 = parsed.forecast.forecastday[1].date;
        ...
        const date_2 = parsed.forecast.forecastday[2].date;
        ...
        const date_3 = parsed.forecast.forecastday[3].date;
        ...
        const date_4 = parsed.forecast.forecastday[4].date;
