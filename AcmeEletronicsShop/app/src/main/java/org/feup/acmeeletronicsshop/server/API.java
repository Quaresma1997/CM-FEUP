package org.feup.acmeeletronicsshop.server;
...
//              connection.setDoOutput(true);
    ...
    public String getProductByID(String id) {
        String response = createConnection(url_api + "products/" + id, "GET", null, null, null);
        return response;
    }

    public String getAllProducts() {
        String response = createConnection(url_api + "products/", "GET", null, null, null);
        return response;
    }

    public String getShoppingListByUser(String id) {
        String response = createConnection(url_api + "shoppingList/" + id, "GET", null, null, null);
        return response;
    }

    public String addProductToCart(String idUser, String idProduct) {
        String response = createConnection(url_api + "shoppingList/add/" + idUser  + "/" + idProduct, "GET", null, null, null);
        return response;
    }

    public String removeProductFromCart(String idUser, String idProduct) {
        String response = createConnection(url_api + "shoppingList/remove/" + idUser  + "/" + idProduct, "GET", null, null, null);
        return response;
    }

    public String addQuantityOfProductToCart(String idUser, String idProduct, String quantity) {
        String response = createConnection(url_api + "shoppingList/add_quantity/" + idUser  + "/" + idProduct + "/", "GET", null, null, null);
        return response;
    }

    public String removeQuantityOfProductFromCart(String idUser, String idProduct, String quantity) {
        String response = createConnection(url_api + "shoppingList/remove_quantity/" + idUser  + "/" + idProduct + "/", "GET", null, null, null);
        return response;
    }
